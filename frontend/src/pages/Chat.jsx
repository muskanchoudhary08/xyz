...
export default function Chat() {
  ...
  const handleSend = async () => {
    ...
    if (!finalReceiverId) {
      setSendError("Receiver ID missing. Open chat from Matches page.");
      return;
    }
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="flex h-[80vh] flex-col rounded-3xl bg-white shadow-sm">
          ...
          <div className="border-b border-slate-200 p-5">
            ...
            <p className="text-sm text-slate-500">Match ID: {matchId}</p>
          </div>
          ...
          <div className="border-t border-slate-200 p-4">
            ...
            {sendError && <p className="mb-2 text-sm text-red-500">{sendError}</p>}
